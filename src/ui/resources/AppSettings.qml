...
Item { id: item
	...
	Column{
		...
		Item{
			...
			Column {
				...
				TextField { id: userName
					font.pixelSize: 14
					text: CacheConnect.userName
					placeholderText: CacheConnect.userName
					height: 40
					width: parent.width
				}
			}
		...
		Item {
			...
			Column {
				...
				Item { id: downloadDir
					...
					TextField { id: downloadDirVal
						...
						placeholderText: CacheConnect.downloadDir
			...
			FileDialog { id: dirDialog
				selectExisting: true
				selectFolder: true
				folder: "file://"+CacheConnect.downloadDir
			}
		}
	...
	Item { id: saveBtn
		...
		IPCButton {
			...
			text: qsTr("Save")
			onClicked: {
				CacheConnect.userName = username;
				CacheConnect.downloadDir = ddir;
				CacheConnect.theme = themeColor
				item.updated()
			}
		}
	}
