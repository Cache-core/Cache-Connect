	...
	Rectangle { id:userListBox
		...
		ScrollView{
			...
			ListView { id:userList
				anchors.fill: parent
				model: CacheConnect.users
				delegate: userDelegate
				highlight: highlightBar
				highlightFollowsCurrentItem: false
				onCurrentIndexChanged: CacheConnect.selectedUser = currentIndex > -1 ? currentItem.idno : -1
			}
		}
	}
